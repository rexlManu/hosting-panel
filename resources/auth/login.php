                                    ...
                                    <form class="login-form mt-4" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mb-0">
                                                <button class="btn btn-primary btn-block" name="login">Einloggen</button>
                                            </div>

                                            <div class="col-12 text-center">
                                                <p class="mb-0 mt-3"><small class="text-dark mr-2">Du hast noch keinne Account?</small> <a href="<?= $helper->url(); ?>register" class="text-dark font-weight-bold">Account erstellen</a></p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
